...
| GPU | **18.15 s** | **60** | 460,400 | **~0.56×** |

→ Epic 67: WGSL 反復を **grid Union-Find** に置換（~75 s → ~18 s、60 クラスタ維持）。MVP ~1.4k 点は **~1.15×**（`notes/2026-07-03_gpu_euclidean_cluster_speedup.md`）。
